...
describe("StoryblokSdk", () => {
  ...
  describe("getStories", () => {
    it("should fetch stories", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("/stories", { params: undefined });
    ...
    it("should fetch stories with parameters", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("/stories", { params });
    });
  });
  ...
  describe("getStory", () => {
    it("should fetch a single story", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith(`/stories/${slug}`, { params: undefined });
      expect(result).toBe(mockResponse);
    });
    ...
    it("should fetch a single story with parameters", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith(`/stories/${slug}`, { params });
    });
  });
  ...
  describe("getTags", () => {
    it("should fetch tags", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("/tags", { params: undefined });
      expect(result).toBe(mockResponse);
    });
  ...
  describe("getLinks", () => {
    it("should fetch links", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("/links", { params: undefined });
      expect(result).toBe(mockResponse);
    });
  ...
  describe("getDatasourceEntries", () => {
    it("should fetch datasource entries", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("/datasource_entries", {
        params: { datasource },
      });
      expect(result).toBe(mockResponse);
    });
